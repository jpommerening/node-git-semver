...
function command(/*arg1, arg2, ..., argN*/) {
  ...
  return function (/*argN+1, argN+2, ..., argN+M, [callback]*/) {
    ...
    var childProcess = this.spawn.apply(this, args);
    var result = {
      gitdir: this.gitdir,
    ...
    if (callback) {
      childProcess.once('error', callback);
