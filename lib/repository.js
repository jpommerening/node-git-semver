...
Repository.prototype.config = function (cb) {
  return utils.pipeEvents(this, 'gitdir', config({local: true}, cb));
};

Repository.prototype.HEAD = function (cb) {
  return utils.pipeEvents(this, 'gitdir', reference('HEAD', cb));
};

Repository.prototype.refs = function () {
  return utils.pipeEvents(this, 'gitdir', refs.apply(null, arguments));
};
...
Repository.prototype.versions = function (/* [range], [cb] */) {
  return utils.pipeEvents(this, 'gitdir', versions.apply(null, arguments));
};

Repository.prototype.latest = function (/* [range], [cb] */) {
  return utils.pipeEvents(this, 'gitdir', versions.latest.apply(null, arguments));
};
...
Repository.prototype.checkout = function (/* [reference], [options], [cb] */) {
  ...
  utils.pipeEvents(this, 'gitdir', 'worktree', cmd);
